...
def main() -> None:
    ...
    target = experiment_dir / "diagnostic_probe_causal_surgery_experiment.py"
    spec = importlib.util.spec_from_file_location("archive_diagnostic_probe_causal_surgery_experiment", target)
