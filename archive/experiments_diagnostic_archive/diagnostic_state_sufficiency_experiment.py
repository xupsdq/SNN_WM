...
def main() -> None:
    ...
    target = experiment_dir / "diagnostic_state_sufficiency_experiment.py"
    spec = importlib.util.spec_from_file_location("archive_diagnostic_state_sufficiency_experiment", target)
