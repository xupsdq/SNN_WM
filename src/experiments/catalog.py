...
EXPERIMENT_SPECS: dict[str, ExperimentSpec] = {
    ...
    "dms_overlap_ux_support_mechanism_experiment": ExperimentSpec(
        ...
        expected_artifacts=("run_config.json", "summary.json", "data/preprobe_stsp_summary.csv"),
    ...
    "overlap_causal_input_perturbation_experiment": ExperimentSpec(
        ...
        expected_artifacts=("run_config.json", "summary.json", "data/pair_condition_pattern_results.csv"),
    ...
    "l3_accumulator_mechanism_experiment": ExperimentSpec(
        ...
        expected_artifacts=("run_config.json", "summary.json", "data/pair_results.csv"),
    ...
    "fig4_chunk_interaction_assay": ExperimentSpec(
        ...
        expected_artifacts=(
            ...
            "summary.json",
            "data/pair_table.csv",
            "data/layer3_peak_morphology_metrics.csv",
            "data/ping_decomposed_summary.csv",
            "data/member_probe_A_summary.csv",
            "data/nonmember_probe_error_summary.csv",
        ),
        primary_csv="layer3_peak_morphology_metrics.csv",
        csv_x="overlap_group",
        csv_y=("shared_peak_excess", "peak_enrichment"),
        csv_group="overlap_group",
    ),
    "chunk_stsp_state_taxonomy": ExperimentSpec(
        ...
        output_flag="--output-dir",
        smoke_args=("--smoke",),
        expected_artifacts=("run_config.json", "summary.json", "data/state_similarity_metrics.csv"),
    ...
    "chunk_stsp_multiitem_sequence": ExperimentSpec(
        ...
        output_flag="--output-dir",
        smoke_args=("--smoke",),
        expected_artifacts=("run_config.json", "summary.json", "data/similarity_summary_metrics.csv"),
    ...
    "chunk_stsp_layer2_peak_boost_attraction": ExperimentSpec(
        experiment_id="chunk_stsp_layer2_peak_boost_attraction",
        title="Chunk STSP Layer2 Peak Boost Attraction",
        legacy_module="src.experiments.chunk.chunk_stsp_layer2_peak_boost_attraction",
        output_flag="--output-dir",
        smoke_args=("--smoke",),
        expected_artifacts=(
            "run_config.json",
            "summary.json",
            "data/layer2_peak_boost_natural_contrast.csv",
            "data/layer2_peak_boost_target_selection.csv",
            "data/layer2_peak_boost_trial_summary.csv",
            "data/layer2_peak_boost_effects.csv",
            "data/layer2_peak_boost_dose_response.csv",
        ),
        primary_csv="layer2_peak_boost_effects.csv",
        csv_x="boost_level",
        csv_y=("delta_fraction_vs_flatten", "delta_enrichment_vs_flatten"),
        csv_group="boost_type",
    ),
    "chunk_stsp_layer2_downstream_integration": ExperimentSpec(
        experiment_id="chunk_stsp_layer2_downstream_integration",
        title="Chunk STSP Layer2 Downstream Integration",
        legacy_module="src.experiments.chunk.chunk_stsp_layer2_downstream_integration",
        output_flag="--output-dir",
        smoke_args=("--smoke",),
        expected_artifacts=(
            "run_config.json",
            "summary.json",
            "data/layer2_downstream_probe_selection.csv",
            "data/layer2_downstream_condition_summary.csv",
            "data/layer2_downstream_paired_effects.csv",
        ),
        primary_csv="layer2_downstream_condition_summary.csv",
        csv_x="l2_memory_condition",
        csv_y=("l2_update_enrichment", "l2_update_difference"),
        csv_group="l1_condition",
    ),
    "chunk_stsp_layer1_overlap_peak_formation": ExperimentSpec(
        ...
        legacy_module="src.experiments.chunk.chunk_stsp_layer1_overlap_peak_formation",
        output_flag="--output-dir",
        smoke_args=("--smoke",),
        expected_artifacts=(
            "run_config.json",
