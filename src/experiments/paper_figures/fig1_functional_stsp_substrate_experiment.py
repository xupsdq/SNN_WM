...
from src.experiments.paper_figures.fig1 import constants as _constants
from src.experiments.paper_figures.fig1.trial_specs import build_trial_specs


def main(argv: Sequence[str] | None = None) -> int:
    return main_for_legacy_module("fig1", argv)
...
__all__ = ["build_trial_specs", "main", *_constants.__all__]
