...
from src.plotting.experiments.similarity_bias_experiment_plot_lib import load_plot_bundle, render_figures


def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plot-only entrypoint for similarity_bias_experiment.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"[Output] Generated {len(figure_paths)} figure groups for similarity_bias_experiment -> {output_dir}", flush=True)
    return 0
